...
import pytest
from contracts.StakingContract import StakingContract


class TestStakingContract:
    """Test suite for StakingContract contract."""
    
    def setup_method(self):
        """Set up test fixtures before each test method."""
        self.owner = "0x1234567890123456789012345678901234567890"
        self.contract = StakingContract(self.owner)
